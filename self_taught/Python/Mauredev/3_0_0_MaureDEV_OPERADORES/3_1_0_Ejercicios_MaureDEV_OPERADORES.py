...
print(siete)
siete = str("7")
print(siete + " es mi numero favorito")
...
print("apple" < "banana") # True, A comes before B alphabetically speaking
print("apple" > "banana") # False, comes after A alphabetically speaking
...
print(not(5 > 20)) # True (5>20 = False but "NOT operator" inverts the result)

# 10. Combina operadores aritméticos y lógicos: Verifica si el número resultante de la expresión 
